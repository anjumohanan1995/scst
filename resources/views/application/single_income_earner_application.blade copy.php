                                        ...
                                        <div class="row addRow">
                                            <div class="col-md-3">
                                                <input type="text" value="{{ old('name') }}"
                                                    class="form-control single__income__earner--add--imputbox " placeholder="പേര്"
                                                    name="name" />
                                                @error('name')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            ...
                                            <div class="col-md-3">
                                                <input type="text" value="{{ old('job') }}" class="form-control single__income__earner--add--imputbox "
                                            ...
                                            <div class="col-md-3">
                                                <input type="text" value="{{ old('salary') }}" class="form-control single__income__earner--add--imputbox "
