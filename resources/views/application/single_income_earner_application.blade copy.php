        ...
        <div class="main-container container-fluid">
            ...
            <div class="breadcrumb-header justify-content-between row me-0 ms-0">
                <div class="col-md-12">
                    ...
                    <h2>ഏകവരുമാനദായകന്റെ മരണം തെളിയിക്കുന അപേക്ഷഫോറം </h2>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-6">
                                            ...
                                            <input type="text" value="{{ old('husband_address') }}" class="form-control"
                                                placeholder="Husband Address" name="husband_address" />
                                        ...
                                        <div class="col-md-6 mb-6">
                                            ...
                                            <input type="text" value="{{ old('wife_address') }}" class="form-control"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-6">
                                            ...
                                            <input type="text" value="{{ old('wife_address_old') }}"
                                                class="form-control" placeholder="Wife Address" name="wife_address_old" />
                                            <span id="nameError" class="text-danger"></span>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-6">
                                            <label class="form-label">Husband / ഭർത്താവ് </label>
                                            <input type="text" value="{{ old('husband_caste') }}" class="form-control"
                                                placeholder="Husband Caste" name="husband_caste" />
                                            @error('husband_caste')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-6">
                                            <label class="form-label">Husband / ഭർത്താവ് </label>
                                            <input type="text" value="{{ old('husband_age') }}" class="form-control"
                                                placeholder="വിവാഹ സമയത്തെ പ്രായം" name="husband_age" />
                                            @error('husband_age')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
