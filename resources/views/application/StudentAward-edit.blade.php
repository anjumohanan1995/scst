            ...
            <div class="main-content-body">
                <div class="row row-sm mt-4">
                    <div class="col-lg-12 col-xl-12 col-md-12 col-sm-12 ">
                        ...
                        <form name="patientForm" id="patientForm" method="post" action="{{ route('studentAwardUpdate',['id' => @$datas->id]) }}" enctype="multipart/form-data">
                            @csrf
                            <div class="card">
                                <div class="card-body">
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 mb-4">
                                                ...
                                                <textarea type="text" class="form-control" name="address">{{ @$datas->address }}</textarea>
                                                @error('address')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                                ...
                                                <select id="district" name="district" class="form-control">
                                                    ...
                                                    @foreach ($districts as $district)
                                                        <option value="{{ $district->id }}"
                                                            @if ($district->id == @$datas->district) selected @endif>
                                        ...
                                        <div class="row">
                                                    ...
                                                    <div class="col-md-6 mb-6">
                                                        <div>
                                                            <input type="radio" id="sslc" name="examination_passed"
                                                                value="SSLC"
                                                                {{ @$datas->examination_passed == 'SSLC' ? 'checked' : '' }}>
                                                            <label for="sslc">SSLC</label>
                                                        </div>
                                                        <div>
                                                            <input type="radio" id="plus_two" name="examination_passed"
                                                                value="PLUS TWO"
                                                                {{ @$datas->examination_passed == 'PLUS TWO' ? 'checked' : '' }}>
                                                    ...
                                                    <div class="col-md-6 mb-6">
                                                        <div>
                                                            <input type="radio" id="degree" name="examination_passed"
                                                                value="DEGREE"
                                                                {{ @$datas->examination_passed == 'DEGREE' ? 'checked' : '' }}>
                                                            <label for="degree">DEGREE</label>
                                                        </div>
                                                        <div>
                                                            <input type="radio" id="pg" name="examination_passed"
                                                                value="PG"
                                                                {{ @$datas->examination_passed == 'PG' ? 'checked' : '' }}>
                                            ...
                                            <div class="col-md-4 mb-4">
                                                ...
                                                <input type="text" class="form-control" name="guardian_name"
                                                    id="guardian_name" value="{{ @$datas->guardian_name }}"
                                                    placeholder="" />
                                                @error('guardian_name')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            ...
                                            <div class="col-md-4 mb-4">
                                                ...
                                                <input type="text" class="form-control" name="community"
                                                    id="community" value="{{ @$datas->community }}" placeholder="" />
                                                @error('community')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-4 mb-4">
                                                ...
                                                <input type="text" class="form-control" name="panchayath_name"
                                                    id="panchayath_name" value="{{ @$datas->panchayath_name }}"
                                                    placeholder="" />
                                            ...
                                            <div class="col-md-4 mb-4">
                                                ...
                                                <input type="text" class="form-control" name="institution_name"
                                                    id="institution_name" value="{{ @$datas->institution_name }}"
                                                    placeholder="" />
                                            ...
                                            <div class="col-md-2 mb-2">
                                                ...
                                                <input type="text" class="form-control" name="pass_month"
                                                    id="pass_month" value="{{ @$datas->pass_month }}" placeholder="" />
                                                @error('pass_month')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                            <div class="col-md-2 mb-2">
                                                ...
                                                <input type="number" class="form-control" name="pass_year"
                                                    id="pass_year" value="{{ @$datas->pass_year }}" placeholder="" />
                                                @error('pass_year')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 mb-4">
                                                ...
                                                <select class="form-control" name="syllabus">
                                                    ...
                                                    <option value="Kerala" {{ @$datas->syllabus == 'Kerala' ? 'selected' : '' }}>Kerala</option>
                                                    <option value="CBSC" {{ @$datas->syllabus == 'CBSC' ? 'selected' : '' }}>CBSE</option>
                                                </select>
                                                @error('syllabus')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            ...
                                            <div class="col-md-4 mb-4">
                                                ...
                                                <input type="file" class="form-control" name="syllabus_certificate"
                                                    id="syllabus_certificate" value="{{ @$datas->syllabus_certificate }}" placeholder="" />
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 mb-4">
                                                ...
                                                <input type="number" class="form-control" name="account_number"
                                                    id="account_number" value="{{ @$datas->account_number }}"
                                                    placeholder="" />
                                            ...
                                            <div class="col-md-4 mb-4">
                                                ...
                                                <input type="text" class="form-control" name="ifsc_code"
                                                    id="ifsc_code" value="{{ @$datas->ifsc_code }}" placeholder="" />
                                                @error('ifsc_code')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 mb-6">
                                                ...
                                                <input type="number" class="form-control" name="aadhar_number"
                                                    id="aadhar_number" value="{{ @$datas->aadhar_number }}"
                                                    placeholder="" />
                                                @error('aadhar_number')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                        ...
                                        <div class="row">
                                          ...
                                          <div class="col-md-1 mb-1">
                                              <input type="checkbox" id="agree" name="agree" value="Yes" required {{ @$datas->agree == 'Yes' ? 'checked' : '' }}>
                                          </div>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-6 mb-6">
                                            ...
                                            @foreach ($districts as $district)
                                                <option value="{{ $district->id }}"
                                                    @if ($district->id == @$datas->submitted_district) selected @endif>{{ $district->name }}
                                                </option>
                                            @endforeach
                                            </select>
                                            @error('dist')
