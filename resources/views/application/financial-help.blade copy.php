                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <input class="form-control" type="radio" name="register_marriage" value="Yes">
                            <label class="form-label">No/അല്ല</label>
                            <input class="form-control" type="radio" name="register_marriage" value="No">
                            </div>
                        </div>
                        <br>
                        <div id="additionalDiv1" style="display:none;">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control" placeholder="Register Number" name="register_details" />
                            </div>
                            <div class="col-md-4">
                                <label class="form-label">Date/തീയതി  </label>
                                <input type="Date" class="form-control" placeholder="Date" name="register_date" />
                            </div>
                            <div class="col-md-4">
                                <label class="form-label">Name of the Registrar's Office/റെജിസ്റ്ററോഫീസിന്റെ പേര്</label>
                                <input type="text" class="form-control" placeholder="r" name="register_office_name" />
                            </div>
                            </div>
                            <br>
                        </div>
                        ...
                        <div id="additionalDiv" style="display:none;">
                            Period of separation/വേർപിരിഞ്ഞ് താമസിച്ച കാലയളവ് 
                            <div class="row">
                            <div class="col-md-12">
                        ...
                        <div class="row">
                            ...
                            ശ്രീമാൻ <input type="text" class="form-control"  id="husband_name_new" required />ശ്രീമതി 
                            <input type="text" class="form-control"  id="wife_name_new" required />
