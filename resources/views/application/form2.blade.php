                            ...
                            <div class="row">
                                <div class="col-md-3 mb-3">
                                    <label class="form-label">വയസ് :</label>
                                        ...
                                        <div class="col-md-8 mb-8">
                                            <input type="text" class="form-control"  name="age" id="age" value="" placeholder="മേൽവിലാസം (പിൻകോഡ് സഹിതം)" />
                                            @error('age')
                                                <span class="text-danger">{{$message}}</span>
                                            @enderror
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-3 mb-3">
                                        <label class="form-label">എത്രാമത്തെ പ്രസവം :</label>
                                            ...
                                            <div class="col-md-8 mb-8">
                                                <input type="text" class="form-control"  name="births" id="births" value="" placeholder="എത്രാമത്തെ പ്രസവം" />
                                                @error('births')
                                                    <span class="text-danger">{{$message}}</span>
                                                @enderror
                                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-3 mb-3">
                                        <label class="form-label">പ്രസവം നടക്കുമെന്ന് പ്രതീക്ഷിക്കുന്ന തിയതി :</label>
                                            ...
                                            <div class="col-md-8 mb-8">
                                                <input type="text" class="form-control"  name="expected_date_of_delivery" id="expected_date_of_delivery" value="" placeholder="പ്രസവം നടക്കുമെന്ന് പ്രതീക്ഷിക്കുന്ന തിയതി" />
