        ...
        <div class="main-content-body">
            <div class="row row-sm mt-4">
                <div class="col-lg-12 col-xl-12 col-md-12 col-sm-12 ">
                            ...
                            <form name="patientForm" id="patientForm" method="post" action="{{route('childFinanceUpdate',['id' => @$datas->id])}}" enctype="multipart/form-data">
                                @csrf
                                <div class="card">
                                    <div class="card-body">
                                <div class="form-group">
                                    <div class="row">   
                                        <div class="col-md-6 mb-6">
                                            ...
                                            <input type="text" value="{{ @$datas->name }}"  class="form-control" placeholder="" name="name" />
                                            @error('name')
                                    ...
                                    <div class="row">   
                                        <div class="col-md-6 mb-6">
                                            ...
                                            <input type="date" value="{{ @$datas->dob }}" class="form-control" placeholder="" name="dob" max="{{ date('Y-m-d') }}" />
                                            @error('dob')
                                                <span class="text-danger">{{$message}}</span>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="col-md-6 mb-6">
                                           ...
                                           <small> (File less than 2 mb. jpg & pdf only. / ഫയൽ: 2 എംബി കുറഞ്ഞത്, JPG/PDF
                                                        മാത്രം.)</small></label>
                                            <input type="file" value="{{ @$datas->birth_certificate }}" class="form-control" id="birth_certificate" onchange="validateImage()"   name="birth_certificate" accept="image/*,application/pdf,application/msword,application/vnd.openxmlformats-officedocument.wordprocessingml.document" />
                                    ...
                                    <div class="row">   
                                        <div class="col-md-6 mb-6">
                                            ...
                                            <input type="text" value="{{ @$datas->father_name }}"  class="form-control" placeholder="" name="father_name" />
                                            @error('father_name')
                                                <span class="text-danger">{{$message}}</span>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="col-md-6 mb-6">
                                            ...
                                            <input type="text" value="{{ @$datas->mother_name }}"  class="form-control" placeholder="" name="mother_name" />
                                            @error('mother_name')
                                                <span class="text-danger">{{$message}}</span>
                                            @enderror
                                    ...
                                    <div class="row">  
                                        ...
                                        <div class="col-md-6 mb-6">
                                            ...
                                            <input type="text" value="{{ @$datas->guardian_name }}"  class="form-control" placeholder="" name="guardian_name" />
                                            @error('guardian_name')
                                                <span class="text-danger">{{$message}}</span>
                                            @enderror
                                        ...
                                        <div class="col-md-6 mb-6">
                                            ...
                                            <textarea type="text" value="{{ @$datas->address }}"  class="form-control" placeholder="" name="address" ></textarea>
                                            @error('address')
                                                <span class="text-danger">{{$message}}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="row">   
                                            ...
                                            <select id="current_district" name="current_district" class="form-control" >
                                                <option value="">Select</option>
                                                    @foreach($districts as $district)
                                                        ...
                                                        <option value="{{ $district->id }}" {{ (@$datas->current_district == $district->id) ? 'selected' : '' }}>
                                                            {{ $district->name }}
                                                        </option>
                                                    @endforeach
                                            </select>
                                        ...
                                        <div class="col-md-4 mb-4">
                                            ...
                                            <input type="number" value="{{ @$datas->current_pincode }}"  class="form-control"  name="current_pincode" />
                                    ...
                                    <div class="row">   
                                        ...
                                        <div class="col-md-4 mb-2">
                                            ...
                                            <input type="text" value="{{ @$datas->email }}"  class="form-control" placeholder="" name="email" />
                                                @error('email')
                                                    <span class="text-danger">{{$message}}</span>
                                                @enderror
                                        </div>
                                        <div class="col-md-4 mb-2">
                                            ...
                                            <input type="number" value="{{ @$datas->mobile }}"  class="form-control" placeholder="" name="mobile" />
                                                @error('mobile')
                                                    <span class="text-danger">{{$message}}</span>
                                                @enderror
                                        </div>
                                    ...
                                    <div class="col-md-6 mb-2">
                                            ...
                                            <input type="text" value="{{ @$datas->account_number }}"  class="form-control" placeholder="" name="account_number" />
                                        ...
                                        <div class="col-md-6 mb-2">
                                            <label class="form-label">ആധാർ ഉണ്ടെങ്കിൽ ആയതിന്റെ നമ്പർ <br> <span class="small"> Aadhaar number if available </span></label>
                                                <input type="number" value="{{ @$datas->aadhar_number }}"  class="form-control" placeholder="" name="aadhar_number" />
                                                @error('aadhar_number')
                                                    <span class="text-danger">{{$message}}</span>
                                                @enderror
                                    ...
                                    <div class="row">   
                                        <div class="col-md-6 mb-2">
                                            ...
                                            <input type="text" value="{{ @$datas->voter_id }}"  class="form-control" placeholder="" name="voter_id" />
                                                @error('voter_id')
                                                    <span class="text-danger">{{$message}}</span>
                                                @enderror
                                        </div>
                                        ...
                                        <div class="col-md-6 mb-2" id="other">
                                            <label class="form-label"> കാരണം സൂചിപ്പിക്കുക <br> <span class="small">  Mention that reason </span></label>
                                                <input type="text" value="{{ @$datas->reason }}"  class="form-control" placeholder="" name="reason" />
                                                @error('reason')
                                                    <span class="text-danger">{{$message}}</span>
                                                @enderror
                                    ...
                                    <div class="row">   
                                        <div class="col-md-6 mb-4">
                                           ...
                                           <small>(File less than 2 mb. jpg only. / ഫയൽ: 2 എംബി കുറഞ്ഞത്, JPG മാത്രം.)</small></label>
                                            <input type="file" value="{{ @$datas->death_certificate }}"  class="form-control" name="death_certificate" id="death_certificate" onchange="validateImageOne()"  accept="image/*"  />
                                        ...
                                        <div class="col-md-6 mb-4">
                                            ...
                                            <small>(File less than 2 mb. jpg only. / ഫയൽ: 2 എംബി കുറഞ്ഞത്, JPG മാത്രം.)</small></label>
                                            <input type="file" value="{{ @$datas->tribal_extension_certificate }}"  class="form-control" name="tribal_extension_certificate" id="tribal_extension_certificate" onchange="validateImageOne()"  accept="image/*"  />
                                    ...
                                    <div class="row">   
                                        ...
                                        <div class="col-md-6 mb-4">
                                         ...
                                         <small>   (File less than 2 mb. jpg only. / ഫയൽ: 2 എംബി കുറഞ്ഞത്, JPG മാത്രം.)</small></label>
                                            <input type="file" value="{{ @$datas->signature }}"  class="form-control" placeholder="അപേക്ഷകന്റെ ഒപ്പ്/വിരലടയാളം" name="signature" id="signature" onchange="validateImageOne()"  accept="image/*"  />
                                            @error('signature')
                                                <span class="text-danger">{{$message}}</span>
                                            @enderror
                                             <div id="errorMessageone" style="color:red;"></div>
                                    ...
                                    <div class="row">   
                                        <div class="col-md-6 mb-4">
                                            ...
                                            (File less than 2 mb. jpg  only. / ഫയൽ: 2 എംബി കുറഞ്ഞത്, JPG
                                                        മാത്രം.)</small></label>
                                            <input type="file" value="{{ @$datas->child_signature }}"  class="form-control" placeholder="കുട്ടിയുടെ ഫോട്ടോ" name="child_signature" id="child_signature" onchange="validateImageTwo()"    accept="image/*" />
