...
@section('content')
            ...
            <div class="main-content-body">
                <div class="row row-sm mt-4">
                    <div class="col-lg-12 col-xl-12 col-md-12 col-sm-12 ">
                        ...
                        <form name="patientForm" id="patientForm" method="post" action="{{ route('houseGrantUpdate',['id' => @$datas->id]) }}" enctype="multipart/form-data">                          
                            @csrf
                            <div class="card">
                                <div class="card-body">
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 mb-6">
                                                ...
                                                <textarea type="text" value="{{ @$datas->address }}" class="form-control" placeholder="Address" name="address">{{ @$datas->address }}</textarea>
                                                @error('address')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3 mb-3">
                                                ...
                                                <input type="text" value="{{ @$datas->panchayath }}" class="form-control"
                                            ...
                                            <div class="col-md-3 mb-3">
                                                ...
                                                <input type="number" value="{{ @$datas->ward_no }}" class="form-control"
                                        ...
                                        <div class="row">
                                            <div class="col-md-3 mb-3">
                                                ...
                                                <textarea type="text" value="{{ @$datas->house_details }}" class="form-control"
                                                    placeholder="Condition of the house for which financing is applied for and the year of sanction"
                                                    name="house_details">{{ @$datas->house_details }}</textarea>
                                                @error('house_details')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                            <div class="col-md-3 mb-3">
                                                ...
                                                <input type="text" value="{{ @$datas->agency }}" class="form-control"
                                            ...
                                            <div class="col-md-6 mb-6">
                                                ...
                                                {{-- <input type="number" id="last_payment_year" class="form-control" name="last_payment_year" min="1000" max="9999" value="{{ @$datas->last_payment_year }}"> --}}
                                                <select class="form-control last_payment_year" id="last_payment_year"
                                                    ...
                                                    @for ($year = date('Y'); $year >= date('Y') - 30; $year--)
                                                        <option value="{{ $year }}"
                                                            {{ @$datas->last_payment_year == $year ? 'selected' : '' }}>
                                                            {{ $year }}</option>
                                                    @endfor
                                                </select>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 mb-6">
                                                ...
                                                <textarea type="text" value="{{ @$datas->family_details }}" class="form-control"
                                                    ...
                                                    name="family_details">{{ @$datas->family_details }}</textarea>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 mb-6">
                                                ...
                                                <div style="border: 1px solid black" class="form-control">
                                                    <input type="radio" id="innovation" name="payment_details"
                                                        value="yes"
                                                        {{ @$datas->payment_details == 'yes' ? 'checked' : '' }}>&nbsp;
                                                    &nbsp;
                                                    ...
                                                    <input type="radio" id="option2" name="payment_details"
                                                        value="no"
                                                        {{ @$datas->payment_details == 'no' ? 'checked' : '' }}>
                                                ...
                                                <div class="row" style="display:none" id="paymentDiv">
                                                    <div class="col-md-6 mb-6">
                                                        ...
                                                        <input type="number" value="{{ @$datas->payment_amount }}"
                                                    ...
                                                    <div class="col-md-6 mb-6">
                                                        ...
                                                        <input type="date" value="{{ @$datas->date_received }}"
                                            ...
                                            <div class="col-md-3 mb-3">
                                                ...
                                                <textarea type="text" value="{{ @$datas->prove_eligibility }}" class="form-control"
                                                    placeholder="Other matters to prove eligibility for preference" name="prove_eligibility">{{ @$datas->prove_eligibility }}</textarea>
                                            ...
                                            <div class="col-md-3 mb-3">
                                                ...
                                                <input type="file" class="form-control" accept="pdf/doc"
                                                    ...
                                                    value="{{ @$datas->prove_eligibility_file }}" placeholder=" " />
    ...
    <script type="text/javascript">
        ...
        @if (!empty(@$datas->current_district))
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    var permanentTalukValue = "{{ @$datas->current_taluk }}";
        ...
        @if (!empty(@$datas->submitted_district))
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    // Set the selected value for permanent_taluk
                    var permanentTeoValue = "{{ @$datas->submitted_teo }}";
        ...
        $('#current_district').change(function() {
            ...
            $.ajax({
                ...
                success: function(result) {
                    ...
                    var oldValue = "{{ @$datas->current_taluk }}";
