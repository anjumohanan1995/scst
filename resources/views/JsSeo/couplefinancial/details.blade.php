                 ...
                 <div id="print_content">
                     ...
                     <div class="row">
                        ...
                        <div class="col-md-6 mb-6">
                         <a href="{{ route('couplefinancialListJsSeo') }}">  <input type="button" class="btn btn-primary" value="Back >>" >
                         </a>  </div>
                         </div><br>
                     </div>
                  </div>
...
<script>
   $(document).on("click",".approveItem",function() {
    ...
    function approve() {
         ...
         $.ajax({
             url: "{{ route('couplefinancial.JsSeo.approve') }}",
             type: "POST",
             data: {
                 "id": reqId,
                 "reason": reason,
     ...
     function reject() {
         ...
         if ($('#reason').val() == "") {
             ...
             $.ajax({
                 ...
                 url: "{{ route('couplefinancial.JsSeo.reject') }}",
                 type: "POST",
                 data: {
                     "id": reqId,
                     "reason": reason,
