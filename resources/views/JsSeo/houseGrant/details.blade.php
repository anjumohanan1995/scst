               ...
               <div class="card-body p-5">
                  ...
                  <div class="row">
                     ...
                     <div class="col-md-6 mb-6">
                        <a href="{{ route('houseGrantListJsSeo') }}">  <input type="button" class="btn btn-primary" value="Back >>" >
                        </a>  
                     </div>
                  </div>
                  <br>
...
<script>
   $(document).on("click",".approveItem",function() {
    ...
    function approve() {
         ...
         $.ajax({
             url: "{{ route('houseGrant.JsSeo.approve') }}",
             type: "POST",
             data: {
                 "id": reqId,
                 "reason": reason,
     ...
     function reject() {
         ...
         if ($('#reason').val() == "") {
             ...
             $.ajax({
                 ...
                 url: "{{ route('houseGrant.JsSeo.reject') }}",
                 type: "POST",
                 data: {
                     "id": reqId,
                     "reason": reason,
