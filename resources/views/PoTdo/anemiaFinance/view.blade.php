                     ...
                     <div id="print_content">
                        ...
                        <form action="#" method="post">
                           ...
                           <div class="col-md-6 mb-6">
                              <a href="{{ route('anemiaFinanceListOfficer') }}">  <input type="button" class="btn btn-primary" value="Back >>" >
                              </a>
                           </div>
                        </form>
                     </div>
...
<script>
   ...
   $.ajax({
           url: "{{ route('anemiaFinance-officer.approve') }}",
           type: "POST",
           data: {
               "id": reqId,
               "reason" :reason,
   ...
   $.ajax({
       ...
       url: "{{ route('anemiaFinance-officer.reject') }}",
       type: "POST",
           data: {
               "id": reqId,
               "reason" :reason,
