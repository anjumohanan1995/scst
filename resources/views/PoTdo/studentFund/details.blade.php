                                  ...
                                  <br>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-6">
                                         <a href="{{ route('StudentFundListOfficer') }}">  <input type="button" class="btn btn-primary" value="Back >>" >
                                         </a>  </div>
                     ...
                     <ul class="timeline-3"> 
                        ...
                        <li class="ApproveTimeline">
                           ...
                           <div class="settings-icon">
                              ...
                              &nbsp;&nbsp;<a class="removeItem" data-id="{{ @$studentFund->id }}"><i class="fa fa-times bg-danger "></i></a>
