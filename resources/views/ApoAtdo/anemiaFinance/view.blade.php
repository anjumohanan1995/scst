                     ...
                     <div id="print_content">
                        ...
                        <form action="#" method="post">
                           ...
                           <div class="col-md-6 mb-6">
                              <a href="{{ route('anemiaFinanceListAssistant') }}">  <input type="button" class="btn btn-primary" value="Back >>" >
                              </a>
                           </div>
                     </div>
                     </form>
...
<script>
   ...
   $.ajax({
           url: "{{ route('anemiaFinance-assistant.approve') }}",
           type: "POST",
           data: {
               "id": reqId,
               "reason" :reason,
   ...
   $.ajax({
       ...
       url: "{{ route('anemiaFinance-assistant.reject') }}",
       type: "POST",
           data: {
               "id": reqId,
               "reason" :reason,
