		...
		<div class="main-content-body">
			...
			<div class="row row-sm">
                <div class="col-sm-12 col-md-12 col-lg-8">
                          ...
                          <form action="#" method="post"
                             ...
                             <div class="row">
                              ...
                              <div class="col-md-6 mb-6">
                               <a href="{{ route('examApplicationListAssistant') }}">  <input type="button" class="btn btn-primary" value="Back >>" >
                               </a>  </div>
                               </div><br>
                           </div>
                          </form>
                 ...
                 @if( Auth::user()->role == 'ATDO' || Auth::user()->role == 'APO') 
...
<script>
      $(document).on("click",".approveItem",function() {
       ...
       function approve() {
            ...
            $.ajax({
                url: "{{ route('examApplication.assistant.approve') }}",
                type: "POST",
                data: {
                    "id": reqId,
                    "reason": reason,
        ...
        function reject() {
            ...
            if ($('#reason').val() == "") {
                ...
                $.ajax({
                    ...
                    url: "{{ route('examApplication.assistant.reject') }}",
                    type: "POST",
                    data: {
                        "id": reqId,
                        "reason": reason,
