               ...
               <div class="card-body pd-y-5">
                  ...
                  <div id="print_content">
                     ...
                     <div class="col-md-6 mb-6">
                        <a href="{{ route('ChildFinanceListAssistant') }}">  <input type="button" class="btn btn-primary" value="Back >>" >
                        </a>  
                     </div>
                     {{-- 
                     <div class="m-5">
...
<script>
   $(document).on("click",".approveItem",function() {
    ...
    function approve() {
         ...
         $.ajax({
             url: "{{ route('childFinance.assistant.approve') }}",
             type: "POST",
             data: {
                 "id": reqId,
                 "reason": reason,
     ...
     function reject() {
         ...
         if ($('#reason').val() == "") {
             ...
             $.ajax({
                 ...
                 url: "{{ route('childFinance.assistant.reject') }}",
                 type: "POST",
                 data: {
                     "id": reqId,
                     "reason": reason,
