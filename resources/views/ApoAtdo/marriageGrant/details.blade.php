                    ...
                    <div id="print_content">
                     ...
                     <div class="row">
                        ...
                        <div class="col-md-6 mb-6">
                         <a href="{{ route('marriageGrantListAssistant') }}">  <input type="button" class="btn btn-primary" value="Back >>" >
                         </a>  </div>
...
<script type="text/javascript">
   $(document).on("click", ".approveItem", function() {
       ...
       $.ajax({
                   url: "{{ route('marriageGrant.assistant.approve') }}",
                   type: "POST",
                   data: {
                       "id": reqId,
                       "reason" :reason,
   ...
   function reject() {
           ...
           $.ajax({
               ...
               url: "{{ route('marriageGrant.assistant.reject') }}",
               type: "POST",
                   data: {
                       "id": reqId,
                       "reason" :reason,
