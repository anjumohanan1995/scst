                    ...
                    <div class="col-lg-12 col-xl-12 col-md-12 col-sm-12 ">
                        ...
                        <form name="patientForm" id="patientForm" method="post"
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-md-4 mb-4">
                                                ...
                                                <input type="text" value="{{ $datas->name ?? old('name') }}"
                                                    class="form-control" placeholder="പേര്" name="name" />
                                                @error('name')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                            <div class="col-md-4 mb-4">
                                                <label class="form-label">ജനനതീയതി <br><span class="small"> Date of Birth
                                                    </span> </label>
                                                <input type="date" class="form-control" name="dob" id="dob"
                                                    value="{{ $datas->dob ?? old('dob') }}" />
                                                @error('dob')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                            <div class="col-md-4 mb-4">
                                                <label class="form-label">വയസ് <br><span class="small"> Age </span>
                                                </label>
                                                <input type="number" value="{{ $datas->age ?? old('age') }}"
                                        ...
                                        <div class="row pb-4">
                                            <div class="col-md-6 mb-6">
                                                <label class="form-label">ഇ - മെയിൽ ഐഡി <br><span class="small"> Email Id
                                                    </span> </label>
                                                <input type="text" class="form-control" name="email" id="email"
                                                    value="{{ $datas->email ?? old('email') }}" placeholder="" />
                                                @error('email')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                            <div class="col-md-6 mb-6">
                                                <label class="form-label">ഫോൺ നമ്പർ <br><span class="small"> Phone Number
                                                    </span> </label>
                                                <input type="number" class="form-control" name="phone" id="phone"
                                                    value="{{ $datas->phone ?? old('phone') }}" placeholder="" />
                                                @error('phone')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 mb-6">
                                                ...
                                                <input type="text" value="{{ $datas->caste ?? old('caste') }}"
                                                    class="form-control" name="caste" />
                                                @error('caste')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                            <div class="col-md-6 mb-6">
                                                <label class="form-label">ജാതി സർട്ടിഫിക്കറ്റ് <br><span class="small">
                                                        Caste Certificate </span></label>
                                                <input type="file" class="form-control" name="caste_certificate"
                                                    id="caste_certificate" value="" placeholder=""
                                                    onchange="validateCaste()" />
                                        ...
                                        <div class="row">
                                            <div class="col-md-3 mb-3">
                                                ...
                                                <textarea type="text" class="form-control" name="address">{{ $datas->address ?? old('address') }}</textarea>
                                                @error('address')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                                ...
                                                <select id="district" name="district" class="form-control">
                                                    ...
                                                    @foreach ($districts as $district)
                                                        <option value="{{ $district->id }}"
                                                            {{ $district->id == old('district', $datas->district) ? 'selected' : '' }}>
                                                            {{ $district->name }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="col-md-3 mb-3">
                                                <label class="form-label">പിൻകോഡ് <br><span class="small">T Pincode
                                                    </span></label>
                                                <input type="text" value="{{ $datas->pincode ?? old('pincode') }}"
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 mb-6">
                                                <label class="form-label">ആധാർ നമ്പർ <br><span class="small">Aadhar
                                                        Number </span></label>
                                                <input type="text" pattern="[0-9]{12}" maxlength="12"
                                                    class="form-control" name="adhaar_number" id="adhaar_number"
                                                    value="{{ $datas->adhaar_number ?? old('adhaar_number') }}"
                                            ...
                                            <div class="col-md-6 mb-6">
                                                <label class="form-label">ആധാർ പകർപ്പ് <br><span class="small"> Aadhaar
                                                        copy </span></label>
                                                <input type="file" class="form-control" name="adhaar_copy"
                                                    id="adhaar_copy" value="" placeholder=""
                                                    onchange="validateAdhar()" />
                                                <p style="font-size: 11px;">Max. filesize: 2 MB • Format: JPG, PNG, PDF
                                                </p>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 mb-6">
                                                <label class="form-label">ബാങ്ക് അക്കൗണ്ട് വിശദംശങ്ങൾ <br><span
                                                        class="small"> Bank account details </span> </label>
                                                <textarea type="text" class="form-control" name="bank_account_details" id="bank_account_details" value=""
                                                    placeholder="">{{ $datas->bank_account_details ?? old('bank_account_details') }}</textarea>
                                                @error('bank_account_details')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                            <div class="col-md-6 mb-6">
                                                <label class="form-label">ബാങ്ക് അക്കൗണ്ട് പാസ്സ് ബുക്കിന്റെ പകർപ്പ്
                                                    <br><span class="small"> Copy of Bank Account Pass Book << /span>
                                                </label>
                                                <input type="file" class="form-control" name="passbook_copy"
                                                    id="passbook_copy" value="" placeholder=""
                                                    onchange="validatePassbook()" />
                                                @error('passbook_copy')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 mb-6">
                                                <label class="form-label">റേഷൻ കാർഡ് <br><span class="small"> Ration card
                                                    </span></label>
                                                <div>
                                                    <input type="radio" id="apl" name="ration_card_type"
                                                        value="APL"
                                                        {{ $datas->ration_card_type ?? old('ration_card_type') == 'APL' ? 'checked' : '' }}>
                                                    <label for="apl">APL</label>
                                                </div>
                                                <div>
                                                    <input type="radio" id="bpl" name="ration_card_type"
                                                        value="BPL"
                                                        {{ $datas->ration_card_type ?? old('ration_card_type') == 'BPL' ? 'checked' : '' }}>
                                            ...
                                            <div class="col-md-6 mb-6">
                                                <label class="form-label">റേഷൻ കാർഡ് പകർപ്പ് <br><span class="small">Copy
                                                        of Ration Card </span> </label>
                                                <input type="file" class="form-control" name="ration_card"
                                                    id="ration_card" value="" placeholder=""
                                                    onchange="validateRationcard()" />
                                                <p style="font-size: 11px;">Max. filesize: 2 MB • Format: JPG, PNG, PDF
                                                </p>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 mb-6">
                                                <label class="form-label">മെഡിക്കൽ സർട്ടിഫിക്കറ്റ് ഹാജരാക്കിയിട്ടുണ്ടോ?
                                                    <br><span class="small">Is the medical certificate submitted?
                                                    </span></label>
                                                <div>
                                                    <input type="radio" id="yes"
                                                        name="is_medical_certificate_submitted" value="Yes"
                                                        {{ $datas->is_medical_certificate_submitted ?? old('is_medical_certificate_submitted') == 'Yes' ? 'checked' : '' }}>
                                                    <label for="yes">Yes</label>
                                                </div>
                                                <div>
                                                    <input type="radio" id="no"
                                                        name="is_medical_certificate_submitted" value="No"
                                                        {{ $datas->is_medical_certificate_submitted ?? old('is_medical_certificate_submitted') == 'No' ? 'checked' : '' }}>
                                            ...
                                            <div class="col-md-6 mb-6">
                                                <label class="form-label">മെഡിക്കൽ സർട്ടിഫിക്കറ്റ് <br><span
                                                        class="small">Medical certificate </span> </label>
                                                <input type="file" class="form-control" name="medical_certificate"
                                                    id="medical_certificate" value="" placeholder=""
                                                    onchange="validateMedical()" />
                                                <p style="font-size: 11px;">Max. filesize: 2 MB • Format: JPG, PNG, PDF
                                                </p>
                            ...
                            <p style="text-align: center;">മേൽ പ്രസ്താവിച്ച വിവരങ്ങൾ പൂർണമായും സത്യമാണെന്ന് ബോധിപ്പിക്കുന്നു</p>  --}}
                                        <div class="row">
                                            <div class="col-md-4 mb-4">
                                                <label class="form-label">സ്ഥലം <br><span class="small"> Place
                                                    </span></label>
                                                <input type="text" class="form-control" name="place" id="place"
                                                    value="{{ $datas->place ?? old('place') }}" placeholder="" />
                                                @error('place')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                            <div class="col-md-4 mb-4">
                                                <label class="form-label">അപേക്ഷകന്റെ ഫോട്ടോ <br><span
                                                        class="small">Applicant's photo</span></label>
                                                <input type="file" class="form-control" name="applicant_photo"
                                                    id="applicant_photo" value="" placeholder=""
                                                    onchange="validatePhoto()" accept=".jpg, .jpeg, .png" />
                                            ...
                                            <div class="col-md-4 mb-4">
                                                <label class="form-label">അപേക്ഷകന്റെ ഒപ്പ് <br><span class="small">
                                                        Applicant's signature </span></label>
                                                <input type="file" class="form-control" name="signature"
                                                    id="signature" value="" placeholder=""
                                                    onchange="validateSignature()" accept=".jpg, .jpeg, .png" />
                                                <p style="font-size: 11px;">Max. filesize: 2 MB • Format: JPG, PNG </p>
                                                @error('signature')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-6 mb-6">
                                            ...
                                            @foreach ($districts as $district)
                                                <option value="{{ $district->id }}"
                                                    @if ($district->id == old('submitted_district', $datas->submitted_district)) selected @endif>{{ $district->name }}
                                                </option>
                                            @endforeach
                                            </select>
                                        ...
                                        <div class="col-md-6 mb-6">
                                            ...
                                            <input type="hidden" name="teo_name" id="teo_name"
                                                value="{{ $datas->teo_name ?? old('teo_name') }}">
                                        </div>
                                    </div><br>
                                </div>
                            </div>
