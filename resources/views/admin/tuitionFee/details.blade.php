            ...
            <div class="main-content-body">
                                ...
                                <div id="print_content">
                                    ...
                                    <form action="#" method="post"
                                        ...
                                        <div class="col-md-6 mb-6">
                                            <a href="{{ route('adminTuitionFeeList') }}"> <input type="button"
                                ...
                                <div class="card-body">
                                    @if (@$formData->return_status == 1)
                                        ...
                                        <p class="inputText badge bg-danger" style="font-size: 12px">Returned Application
                                            -
                                            by {{ @$formData->returnUser->name }} ({{ @$role }})</p>
                                        <ul class="timeline-3">
                                                    ...
                                                    @if (@$formData->assistant_return == null)
                                                        @if (@$formData->officer_return == null)
                                                            <li class="ApproveTimeline">
                                                                ...
                                                                <p class="mt-2"><span class= "spanclr"> Approved Reason
                                                                        : </span>{{ @$formData->officer_status_reason }}
                                                                </p>
                                                            </li>
                ...
                <script>
                    ...
                    function approve() {
                        ...
                        $.ajax({
                            url: "{{ route('tuitionFee-teo.approve') }}",
                            type: "POST",
                            data: {
                                "id": reqId,
                                "reason": reason,
                    ...
                    function reject() {
                        ...
                        if ($('#reason').val() == "") {
                            ...
                            $.ajax({
                                ...
                                url: "{{ route('tuitionFee-teo.reject') }}",
                                type: "POST",
                                data: {
                                    "id": reqId,
                                    "reason": reason,
