    ...
    <div class="main-content app-content">
        ...
        <div class="main-container container-fluid">
            ...
            <div class="breadcrumb-header justify-content-between row me-0 ms-0">
                ...
                <h4 class="content-title mb-2">പട്ടിക വർഗ്ഗ വികസന വകുപ്പിൽ നിന്നും 8 ,9 ,10 ,11 ,12 ക്ലാസ്സുകളിൽ പഠിക്കുന്നു
                    കുട്ടികൾക്ക് ട്യൂഷൻ ഫീസിനുള്ള അപേക്ഷ
                ...
                <div class="row row-sm mt-4">
                    <div class="col-lg-12 col-xl-12 col-md-12 col-sm-12 ">
                        ...
                        <form name="patientForm" id="patientForm" method="post"
                            action="{{ route('tuitionFeeUpdate', ['id' => $datas->id]) }}" enctype="multipart/form-data">
                            @csrf
                            <div class="card">
                                <div class="card-body">
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 mb-6">
                                                ...
                                                <textarea type="text" class="form-control" placeholder="മേൽവിലാസം" name="address">{{ $datas->address }}</textarea>
                                                @error('address')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-2 mb-2">
                                                <label class="form-label">ജില്ല <br><span class="small">District</span>
                                                </label>
                                                ...
                                                <input type="hidden" name="current_district_name"
                                                    id="current_district_name" value="{{ $datas->current_district_name }}">
                                            </div>
                                            <div class="col-md-2 mb-2">
                                                <label class="form-label">താലൂക്ക് <br><span class="small">Taluk</span>
                                                </label>
                                                ...
                                                <input type="hidden" name="current_taluk_name" id="current_taluk_name"
                                                    value="{{ $datas->current_taluk_name }}">
                                            </div>
                                            <div class="col-md-2 mb-2">
                                                <label class="form-label">പിൻകോഡ് <br><span class="small">Pincode</span>
                                                </label>
                                                <input type="text" value="{{ $datas->current_pincode }}"
                                            ...
                                            <div class="col-md-6 mb-6">
                                                <label class="form-label"> പഞ്ചായത്തിൻ്റെ പേര് <br><span class="small">Name
                                                        of Panchayath </span>


                                                </label>
                                                <input type="tel" value="{{ $datas->panchayath }}" class="form-control"
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 mb-6">
                                                <label class="form-label">ഫോൺ നമ്പർ <br><span class="small">Mobile
                                                        No</span>


                                                </label>
                                                <input type="tel" value="{{ $datas->mobile }}" class="form-control"
                                                    placeholder="ഫോൺ നമ്പർ " name="mobile" />
                                            ...
                                            <div class="col-md-6 mb-6">
                                                <label class="form-label">ജാതി /മതം <br><span class="small">
                                                        Caste/Religion</span>
                                                </label>
                                                <input type="text" value="{{ $datas->caste }}" class="form-control"
                                                    placeholder="ജാതി /മതം" name="caste" />
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 mb-6">
                                                ...
                                                <input type="number" value="{{ $datas->annual_income }}"
                                                    class="form-control" placeholder="വരുമാനം" name="annual_income" />
                                            ...
                                            <div class="col-md-6 mb-6">
                                                <label class="form-label"> വിദ്യാർത്ഥിയുടെ പേര് <br><span class="small">
                                                        Name of the student </span>


                                                </label>
                                                <input type="text" class="form-control"
                                                    value="{{ $datas->student_name }}" name="student_name"
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 mb-6">
                                                <label class="form-label">അപേക്ഷകനുമായുള്ള ബന്ധം <br><span class="small">
                                                        Relationship with the Applicant</span>
                                                ...
                                                <select class="form-select" name="relation">
                                                    ...
                                                    <option value="father"
                                                        @if ($datas->relation == 'father') selected @endif>
                                                        Father / അച്ഛൻ</option>
                                                    <option value="mother"
                                                        @if ($datas->relation == 'mother') selected @endif>
                                                        Mother / അമ്മ</option>
                                                    ...
                                                    <option value="grandmother"
                                                        ...
                                                        മുത്തശ്ശി</option>
                                                    <option value="uncle"
                                                        @if ($datas->relation == 'uncle') selected @endif>
                                                        Uncle / മാമൻ </option>
                                                    <option value="aunt"
                                                        @if ($datas->relation == 'aunt') selected @endif>
                                                        Aunt / മാമി </option>
                                                    <option value="cousin"
                                                        @if ($datas->relation == 'cousin') selected @endif>
                                                        Cousin / സഹോദര / സഹോദരി</option>
                                                    <option value="siblings"
                                                        @if ($datas->relation == 'siblings') selected @endif>Siblings / സഹോദര /
                                                        സഹോദരി</option>
                                                    <option value="others"
                                                        @if ($datas->relation == 'others') selected @endif>
                                            ...
                                            <div class="col-md-6 mb-6">
                                                <label class="form-label"> പഠിക്കുന്ന സ്‌കൂളിന്റെ പേര് <br><span
                                                        class="small">Name of school Studying </span>

                                                </label>


                                                <input type="text" class="form-control" name="school_name"
                                                    id="school_name" value="{{ $datas->school_name }}"
                                                    placeholder="പഠിക്കുന്ന സ്‌കൂളിന്റെ പേര്" />
                                                @error('school_name')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 mb-6">
                                                ...
                                                <input type="number" class="form-control" name="class_number"
                                                    id="class_number" value="{{ $datas->class_number }}"
                                                    placeholder="ക്ലാസ് " />
                                                @error('class_number')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            ...
                                            <div class="col-md-6 mb-6">
                                                <label class="form-label">ട്യുഷൻ സെന്ററിന്റെ പേര് <br><span
                                                        class="small"> Name of Tuition Centre</span>

                                                </label>
                                                <input type="text" class="form-control" name="tuition_center"
                                                    id="tuition_center" value="{{ $datas->tuition_center }}"
                                                    placeholder="ട്യുഷൻ സെന്ററിന്റെ പേര് " />
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 mb-6">
                                                <label class="form-label">പ്രിൻസിപ്പലിൻ്റെ പ്രഖ്യാപനം (ഫയൽ അപ്‌ലോഡ്)
                                                    <br><span class="small">Declaration of Principal(File Upload) </span>
                                                </label>
                                                <input type="file" value="{{ $datas->principal_declaration }}"
                                                    class="form-control"
                                                    placeholder="പ്രിൻസിപ്പലിൻ്റെ പ്രഖ്യാപനം (ഫയൽ അപ്‌ലോഡ്)"
                                                    name="principal_declaration" id="principal_declaration"
                                                    onchange="validatePrincipalFile()" accept=".pdf,.docs" />
                                            ...
                                            <div class="col-md-6 mb-6">
                                                ...
                                                <input type="text" class="form-control" name="place" id="place"
                                                    value="{{ $datas->place }}" placeholder="സ്ഥലം " />
                                                @error('place')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 mb-4">
                                                <label class="form-label">അപേക്ഷകന്റെ ഒപ്പ്/വിരലടയാളം <br><span
                                                        class="small">Applicant's Signature/Fingerprint</span></label>
                                                <input type="file" value="{{ old('signature') }}"
                                                    class="form-control" placeholder="അപേക്ഷകന്റെ ഒപ്പ്/വിരലടയാളം"
                                                    name="signature" id="signature" onchange="validateImage()"
                                                    accept="image/*" />
                                                @error('signature')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            ...
                                            <div class="col-md-6 mb-4">
                                                ...
                                                <input type="file" value="{{ old('photo') }}" class="form-control"
                                                    placeholder="അപേക്ഷകന്റെ ഫോട്ടോ" name="photo" id="photo"
                                                    onchange="validateImageOne()" accept="image/*" />
                                                @error('photo')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                        ...
                                        <br>
                                        <hr>
                                        <label class="form-label"><b>മാതാപിതാക്കളുടെ അക്കൗണ്ട് വിശദാംശങ്ങൾ <br><span
                                                    class="small">Parent account Details </b></span></label>
                                        <br>
                                        <div class="row">
                                            <div class="col-md-4 mb-4">
                                                ...
                                                <input type="text" value="{{ old('parent_bank_branch') }}"
                                                    ...
                                                    name="parent_bank_branch" value="{{ $datas->parent_bank_branch }}">
                                            ...
                                            <div class="col-md-4 mb-4">
                                                ...
                                                <input type="text" value="{{ $datas->parent_ifsc_code }}"
                                                    class="form-control" placeholder="IFSC കോഡ്" name="parent_ifsc_code">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-1 mb-1">
                                                <input type="checkbox" id="agree" name="agree" value="Yes"
                                                    required {{ $datas->agree == 'Yes' ? 'checked' : '' }}>
                                            </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-6">
                                            <label class="form-label"> ടി .ഇ .ഓ <br> <span class="small">TEO</span>
                                            </label>
