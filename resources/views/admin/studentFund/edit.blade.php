                ...
                <div class="row row-sm mt-4">
                    <div class="col-lg-12 col-xl-12 col-md-12 col-sm-12 ">
                        ...
                        <form name="patientForm" id="patientForm" method="post"
                            action="{{ route('MedicalEngineeringStudentFundupdate',@$datas->id) }}" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="card">
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 mb-6">
                                                ...
                                                <input type="text" value="{{ @$datas->course_name }}" class="form-control"
                                    ...
                                    --}}
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 mb-6" style="display: none;" id="othersDiv">
                                                ...
                                                <input type="text" value="{{ @$datas->other_details }}"
                                                    class="form-control" placeholder="Others Details "
                                                    name="other_details" value="{{ @$datas->other_details }}">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3 mb-3">
                                                ...
                                                <input type="number" value="{{ @$datas->income }}" class="form-control"
                                                ...
                                                <div class="row" style="display:none" id="accountDiv">
                                                    <div class="col-md-4 mb-4">
                                                       ബാങ്ക് ശാഖ Bank Branch 
                                                        ...
                                                        <input type="text" value="{{ @$datas->bank_branch }}"
