                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 mb-6">
                                                <label class="form-label">കോഴ്‌സിൻ്റെ പേര് <br><span class="small"> Course
                                                        Name </span>
                                            ...
                                            <div class="col-md-6 mb-6">
                                                <label class="form-label">
                                                    മെട്രിക് അല്ലെങ്കിൽ നോൺ മെട്രിക്?<br><span class="small"> Metric or Non
                                                        Metric ? </span></label>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 mb-6">
                                                <label class="form-label"> കോഴ്‌സിൻ്റെ ദൈർഘ്യം <br><span class="small">
                                            ...
                                            <div class="col-md-6 mb-6">
                                                <label class="form-label">സ്ഥാപനത്തിൻ്റെ തരം <br><span class="small">
                                                        Type Of Institution </span>

                                                </label>

                                                <select class="form-select " id="institution_type"
                                                    name="institution_type" aria-label="Floating label select example">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 mb-6">
                                                <label class="form-label">പ്രവേശന തീയതി <br><span class="small"> Date of
                                                        Admission
                                                    </span>
                                                </label>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="row d-flex">
                                                <div class="col-md-6 mb-6">
                                                    <label class="form-label">അപേക്ഷകനെ പ്രവേശനം ലഭിച്ചത് <br><span
                                                            class="small"> Applicants are admitted </span>
                                                ...
                                                <div class="col-6 ">
                                                    <label class="form-label"> അപേക്ഷകന്റെ ജാതി/ മതം (സർട്ടിഫിക്കറ്റ്
                                                        ഹാജരാക്കണം ) <br><span class="small"> Caste/Religion of Applicant
                                                            (Certificate to be
                                                            produced)</span>
                                                    </label>
                                                    <div class="d-flex">
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <span class="small"> (File less than 2 mb. jpg & pdf only. /
                                                                ഫയൽ:
                                            ...
                                            <div class="row d-flex">
                                                <div class="col-md-6 mb-6">
                                                    <label class="form-label">
                                                        ...
                                                        വിദ്യാർത്ഥികൾക്ക് ഇ-ഗ്രാൻഡ് അകൗണ്ട് നമ്പർ ഉണ്ടോ ? <br><span
                                                            class="small"> Do students have an e-grand account
                                                            number?</span></label>
                                                    <div style="border: 1px solid black" class="form-control">
                                                ...
                                                <div class="col-md-6 mb-6">
                                                    ...
                                                    <span class="small"> (File less than 2 mb. jpg & pdf only. / ഫയൽ: 2
                                                        എംബി
                                                        കുറഞ്ഞത്, JPG/PDF
                                                        മാത്രം.)</span>
                                                    @error('signature')
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 mb-6">
                                                    <label class="form-label"> രക്ഷാകർത്താവിന്റെ പേര് <br><span
                                                            class="small"> Parent's Name </span>
                                                ...
                                                <div class="col-md-6 mb-6">
                                                    <label class="form-label">ഹാജർ വിശദാംശങ്ങൾ അപ്‌ലോഡ് ചെയ്യുക <br><span
                                                            class="small"> Attendance Details upload </span>
                                                    </label>
                                                    ...
                                                    <span class="small"> (File less than 2 mb. jpg ,png,doc, pdf only. /
                                                        ഫയൽ: 2 എംബി
                                                        കുറഞ്ഞത്, JPG/PDF
                                                        മാത്രം.)</span>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 mb-6">
                                                <label class="form-label">
                                                    (അപേക്ഷകന്റെ ഫോട്ടോ )<br><span class="small"> Applicant's Image( Max
                                            ...
                                            <div class="col-md-6 mb-6">
                                                <label class="form-label"> സ്ഥാപനം <br><span class="small">
                                                        Institution</span> </label>
                                        ...
                                        <label class="form-label"><b>മാതാപിതാക്കളുടെ അക്കൗണ്ട് വിശദാംശങ്ങൾ <br><span
                                            ...
                                            <label class="form-label"><b>പ്രിൻസിപ്പൽ അക്കൗണ്ട് വിശദാംശങ്ങൾ <br><span
                                                        class="small"> Principal account details </span></b></label>
                                            <br>
                                            <div class="row">
                                                <div class="col-md-4 mb-4">
                                                    ബാങ്ക് ശാഖ <br><span class="small"> Bank Branch </span>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-9 mb-9">
                                                    ...
                                                    പ്രതിജ്ഞ ചെയ്തുകൊള്ളുന്നു.<br><br>
                                                    We here by pledge that all the information we have added above is true
                                                    and correct.
                                                </div>
                                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 mb-12">
                                    ...
                                    <button type="reset" id="submit1"
                                        class="btn btn-primary waves-effect waves-light text-center submit">Reset</button>
