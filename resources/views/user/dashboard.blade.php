...
<div class="main-content app-content">
                                        ...
                                        <div class="col-md-4 mb-4">
                                            <div class="card-content">
                                                ...
                                                <div class="card-desc">
                                                    ...
                                                    <p class="ctm-height">മിശ്ര വിവാഹം മൂലം ക്ലേശങ്ങൾ അനുഭവിക്കുന്ന പട്ടികവർഗ്ഗ ദമ്പതികൾക്ക് പട്ടികവർഗ്ഗ വികസന വകുപ്പിൽ നിന്നും സാമ്പത്തിക സഹായം അനുവദിക്കുന്നതിനുള്ള അപേക്ഷഫോറം </p>
                                                        
                                                         <a href="#" class="btn-card" data-toggle="modal" data-target="#coupleGrant">Apply Now</a>
                                        ...
                                        <div class="col-md-4 mb-4">
                                            <div class="card-content">
                                                ...
                                                <div class="card-desc">
                                                    ...
                                                    <p class="ctm-height">ജനനി-ജനനി -ജന്മരക്ഷ  പ്രസവാനുകുല്യം - മാതൃശിശു  സംരക്ഷണ പദ്ധതി  അപേക്ഷഫോറം </p>
                                        ...
                                        <div class="col-md-4 mb-4">
                                            <div class="card-content">
                                                ...
                                                <div class="card-desc">
                                                    ...
                                                    <p class="ctm-height">അയ്യങ്കാളി ടാലന്റ് സേർച്ച് &ഡെവലപ്പ്മെന്റ്  സ്‌കീം  പ്രവേശന പരീക്ഷക്കുള്ള അപേക്ഷ</p>
                                        ...
                                        <div class="col-md-4 mb-4">
                                            <div class="card-content">
                                                ...
                                                <div class="card-desc">
                                                    ...
                                                    <p class="ctm-height">പട്ടികവർഗ്ഗത്തിൽപ്പെട്ട  പാവപ്പെട്ട പെണ്കുട്ടികൾക്ക്  വിവാഹധനസഹായം  നൽകുന്നതിനുള്ള അപേക്ഷഫോറം </p>
                                        ...
                                        <div class="col-md-4 mb-4">
                                            <div class="card-content">
                                                ...
                                                <div class="card-desc">
                                                    ...
                                                    <p class="ctm-height">പട്ടികവർഗ്ഗ വികസന വകുപ്പിൽനിന്ന് വീടുകളുടെ നവീകരണത്തിനും അധികസൗകര്യങ്ങൾ ഏർപെടുത്തുന്നതിനും   പൂർത്തീകരിക്കുന്നതിനുമുള്ള 
                                        ...
                                        <div class="col-md-4 mb-4">
                                            <div class="card-content">
                                                ...
                                                <div class="card-desc">
                                                    ...
                                                    <p class="ctm-height">സിക്കിൾസെൽ അനീമിയരോഗികൾക്ക് പ്രതിമാസ ധനസഹായം നൽകുന്ന പദ്ധതി </p>
                                        ...
                                        <div class="col-md-4 mb-4">
                                            <div class="card-content">
                                                ...
                                                <div class="card-desc">
                                                    ...
                                                    <p class="ctm-height">മെഡിക്കൽ / എഞ്ചിനിയറിംഗ് കോഴ്‌സുകളിലെ പട്ടികജാതി വിദ്യാർത്ഥികൾക്ക് പ്രാരംഭചെലവുകൾക്ക് ധനസഹായം അനുവദിക്കുന്നതിനുള്ള അപേക്ഷ </p>
                                        ...
                                        <div class="col-md-4 mb-4">
                                            <div class="card-content">
                                                ...
                                                <div class="card-desc">
                                                    ...
                                                    <p class="ctm-height">മിടുക്കരായ വിദ്യാർത്ഥികൾക്കുള്ള പ്രത്യേക പ്രോത്സാഹനo </p>
                                        ...
                                        <div class="col-md-4 mb-4">
                                            <div class="card-content">
                                                ...
                                                <div class="card-desc">
                                                    ...
                                                    <p class="ctm-height">പട്ടിക വർഗ്ഗ വികസന വകുപ്പിൽ നിന്നും 8 ,9 ,10 ,11 ,12  ക്ലാസ്സുകളിൽ പഠിക്കുന്നു കുട്ടികൾക്ക് ട്യൂഷൻ ഫീസിനുള്ള അപേക്ഷ </p>
                                        ...
                                        <div class="col-md-4 mb-4">
                                            <div class="card-content">
                                                ...
                                                <div class="card-desc">
                                                    ...
                                                    <p class="ctm-height">ഐ.റ്റി.ഐ /ട്രൈനിംഗ് സെന്ററുകളിലെ പഠിതാക്കൾക്കുള്ള സ്കോളർഷിപ്പ്</p>
    ...
    <div class="modal fade" id="studentAward" tabindex="-1" role="dialog" aria-labelledby="applicationModalLabel" aria-hidden="true">
     ...
     <div class="modal fade" id="coupleGrant" tabindex="-1" role="dialog" aria-labelledby="coupleGrantLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <!-- Your form content goes here -->
                <form>
                    <div class="modal-header">
                        <h5 class="modal-title" id="applicationModalLabel">
                            മിശ്ര വിവാഹം മൂലം ക്ലേശങ്ങൾ അനുഭവിക്കുന്ന പട്ടികവർഗ്ഗ ദമ്പതികൾക്ക് പട്ടികവർഗ്ഗ വികസന വകുപ്പിൽ നിന്നും സാമ്പത്തിക സഹായം അനുവദിക്കുന്നതിനുള്ള അപേക്ഷഫോറം 
                        </h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
