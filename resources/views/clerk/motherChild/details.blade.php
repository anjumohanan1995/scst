                           ...
                           <div class="col-6 d-flex">
                              ...
                              <div class="row">
                                 ...
                                 <div class="col-md-6 mb-6">
                                  <a href="{{ route('motherChildSchemeListClerk') }}">  <input type="button" class="btn btn-primary" value="Back >>" >
                                  </a>  </div>
                                  </div><br>
                           </div>
                        </div>
...
<script type="text/javascript">
   $(document).on("click", ".approveItem", function() {
       ...
       $.ajax({
                   url: "{{ route('motherChildScheme.approve') }}",
                   type: "POST",
                   data: {
                       "id": reqId,
                       "reason" :reason,
   ...
   function reject() {
           ...
           $.ajax({
               ...
               url: "{{ route('motherChildScheme.reject') }}",
               type: "POST",
                   data: {
                       "id": reqId,
                       "reason" :reason,
