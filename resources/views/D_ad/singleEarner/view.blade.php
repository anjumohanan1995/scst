                                    ...
                                    <div class="card-body pd-y-7">
                                        ...
                                        <div action="#" method="post"
                                            ...
                                            <div class="col-md-6 mb-6">
                                                <a href="{{ route('singleEarnerListD_ad') }}">  <input type="button" class="btn btn-primary" value="Back >>" >
                                                </a>  </div>
    ...
    <script type="text/javascript">
        ...
        $(document).on("click", ".approveItem", function() {
            var id =$(this).attr('data-id');
                ...
                $.ajax({
                            url: "{{ route('singleEarner-D_ad.approve') }}",
                            type: "POST",
                            data: {
                                "id": reqId,
                                "reason" :reason,
            ...
            function reject() {
                    ...
                    $.ajax({
                        ...
                        url: "{{ route('singleEarner-D_ad.reject') }}",
                        type: "POST",
                            data: {
                                "id": reqId,
                                "reason" :reason,
