...
<li class="slide">
    <a class="side-menu__item {{ \Request::route()->getName() == 'couplefinancialListJsSeo' || \Request::route()->getName() == 'childFinancialJsSeoDetails' ? 'active' : '' }}"
        href="{{ url('couplefinancialListJsSeo') }}">
