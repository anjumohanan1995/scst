                           ...
                           <div id="print_content">
                              ...
                              <div action="#" method="post"
                                 ...
                                 <div class="col-md-6 mb-6">
                                    <a href="{{ route('singleEarnerListOfficer') }}">  <input type="button" class="btn btn-primary" value="Back >>" >
                                    </a>  
                                 </div>
                              </div>
                           </div>
...
<script type="text/javascript">
   $(document).on("click", ".approveItem", function() {
       var id =$(this).attr('data-id');
           ...
           $.ajax({
                       url: "{{ route('singleEarner-officer.approve') }}",
                       type: "POST",
                       data: {
                           "id": reqId,
                           "reason" :reason,
       ...
       function reject() {
               ...
               $.ajax({
                   ...
                   url: "{{ route('singleEarner-officer.reject') }}",
                   type: "POST",
                       data: {
                           "id": reqId,
                           "reason" :reason,
