                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <span class="text-muted small ">(File less than 2 mb. jpg & pdf only. / ഫയൽ: 2 എംബി കുറഞ്ഞത്, JPG/PDF
                                                മാത്രം.)</span>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 d-flex">
                                            ...
                                            <div class="col-md-4 mb-4">
                                                ...
                                                <input type="text"
                                                    value="{{ old('pincode') }}" class="form-control" name="pincode"
                                                    placeholder="പിൻകോഡ്" inputmode="numeric"
                                                    inputmode="numeric" pattern="[0-9]{6}" maxlength="6" oninput="this.value = this.value.replace(/[^0-9]/g, '');" />
                                                @error('pincode')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <input type="text" value="{{ old('applicant_phone') }}"
                                                class="form-control" maxlength="12" placeholder="ഫോൺ നമ്പർ" name="applicant_phone"
                                                inputmode="numeric" 
                                                oninput="this.value = this.value.replace(/[^0-9]/g, '');" />
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <input type="text" value="{{ old('deceased_person_name') }}"
                                                class="form-control" placeholder="പേര്"
                                    ...
                                    <div class="row d-flex align-items-end">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" value="{{ old('deceased_person_age') }}"
                                                ...
                                                inputmode="numeric" pattern="[0-9]{6}" maxlength="3" oninput="this.value = this.value.replace(/[^0-9]/g, '');"/>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="file" value="{{ old('signature') }}"
                                                class="form-control" 
                                                name="signature" />
                                                <span class="text-muted small">(File less than 2 mb. jpg only. / ഫയൽ: 2 എംബി കുറഞ്ഞത്, JPG
                                                    മാത്രം.)</span>
                                            @error('signature')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
