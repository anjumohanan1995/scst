                        ...
                        <div class="mb-4 main-content-label">
                           ...
                           <form action="#" method="post"
                              ...
                              <div class="col-md-6 mb-6">
                                 <a href="{{ route('studentAwardListJsSeo') }}">  <input type="button" class="btn btn-primary" value="Back >>" >
                                 </a>  
                                </div>
                            </div>
                        </div>
...
<script>
   ...
   $.ajax({
               url: "{{ route('studentAward-JsSeo.approve') }}",
               type: "POST",
               data: {
                   "id": reqId,
                   "reason" :reason,
   ...
   function reject() {
       ...
       $.ajax({
           ...
           url: "{{ route('studentAward-JsSeo.reject') }}",
           type: "POST",
               data: {
                   "id": reqId,
                   "reason" :reason,
