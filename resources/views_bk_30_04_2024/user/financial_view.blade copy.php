                                    ...
                                    <table id="example" class="" style="width:100%">
                                        ...
                                        <tr>
                                         ...
                                         @if(@$formData['husband_sign'] != null)
                                            ...
                                            <tr>
                                                <td><a href="{{ asset('/sign/huband/' . @$formData->husband_sign) }}" target="_blank">View</a>
                                                </td>
                                            
                                            </tr>
                                        @endif
                                        @if(@$formData['wife_sign'] != null)
                                            ...
                                            <tr>
                                                <td><a href="{{ asset('/sign/wife/' . @$formData->wife_sign) }}" target="_blank">View</a>
                                                </td>
                                        ...
                                        @endif
                                            ...
                                            <tr>
                                                <td> ശ്രീമാൻ {{ @$formData->husband_name }} ശ്രീമതി {{ @$formData->wife_name }}
