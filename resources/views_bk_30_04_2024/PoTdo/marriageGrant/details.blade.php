                        ...
                        <div class="row">
                           <div class="col-md-4 mb-4">
                              <div class="col-md-6 mb-6">
                                 <a href="{{ route('marriageGrantListOfficer') }}">  <input type="button" class="btn btn-primary" value="Back >>" >
                                 </a>  
                              </div>
                           </div>
                           <br>
...
<script type="text/javascript">
   $(document).on("click", ".approveItem", function() {
       ...
       $.ajax({
                   url: "{{ route('marriageGrant.officer.approve') }}",
                   type: "POST",
                   data: {
                       "id": reqId,
                       "reason" :reason,
   ...
   function reject() {
           ...
           $.ajax({
               ...
               url: "{{ route('marriageGrant.officer.reject') }}",
               type: "POST",
                   data: {
                       "id": reqId,
                       "reason" :reason,
