                          ...
                          <form action="#" method="post"
                             ...
                             <div class="row">
                              ...
                              <div class="col-md-6 mb-6">
                               <a href="{{ route('examApplicationListOfficer') }}">  <input type="button" class="btn btn-primary" value="Back >>" >
                               </a>  </div>
                               </div><br>
                           </div>
                          </form>
...
<script>
      $(document).on("click",".approveItem",function() {
       ...
       function approve() {
            ...
            $.ajax({
                url: "{{ route('examApplication.officer.approve') }}",
                type: "POST",
                data: {
                    "id": reqId,
                    "reason": reason,
        ...
        function reject() {
            ...
            if ($('#reason').val() == "") {
                ...
                $.ajax({
                    ...
                    url: "{{ route('examApplication.officer.reject') }}",
                    type: "POST",
                    data: {
                        "id": reqId,
                        "reason": reason,
