				...
				<div class="main-content app-content">
					...
					<div class="main-container container-fluid">
						...
						<div class="breadcrumb-header justify-content-between row me-0 ms-0" >
							<div class="col-xl-9">
								<h4 class="content-title mb-2">Add Taluk
</h4>
								...
								<div class="col-lg-12 col-xl-12 col-md-12 col-sm-12 ">
									...
									<div class="card">
										...
										<div class="card-body">
												...
												<form name="userForm" id="userForm" method="post" action="{{route('taluks.store')}}">
													@csrf
													...
													<div class="form-group">
														<div class="row">
															...
															<div class="col-md-4 mb-4">
																...
																<input type="text" class="form-control" placeholder="Taluk Name" name="taluk_name" />
																@error('name')
																   <span class="text-danger">{{$message}}</span>
																@enderror
															</div>
