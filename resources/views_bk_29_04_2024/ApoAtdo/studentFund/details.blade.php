                                  ...
                                  <br>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-6">
                                         <a href="{{ route('StudentFundListAssistant') }}">  <input type="button" class="btn btn-primary" value="Back >>" >
                                         </a>  </div>
                       ...
                       <div class="card-body">
                         <ul class="timeline-3">
                             ...
                             <li class="ApproveTimeline">
                                ...
                                <br>
                                <p class="inputText badge bg-success" style="font-size: 12px">Approved </p>
                                <p  class="mt-2"><span class= "spanclr"> Clerk Name :   </span>{{ @$studentFund->clerkUser->name }}</p>
...
<script type="text/javascript">
    ...
    $(document).on("click", ".approveItem", function() {
        ...
        $.ajax({
                    url: "{{ route('studentFund-assistant.approve') }}",
                    type: "POST",
                    data: {
                        "id": reqId,
                        "reason" :reason,
    ...
    function reject() {
            ...
            $.ajax({
                ...
                url: "{{ route('studentFund-assistant.reject') }}",
                type: "POST",
                    data: {
                        "id": reqId,
                        "reason" :reason,
