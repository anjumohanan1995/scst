                                    ...
                                    <div class="card-body pd-y-7">
                                        ...
                                        <div action="#" method="post"
                                            ...
                                            <div class="col-md-6 mb-6">
                                                <a href="{{ route('singleEarnerListDc') }}">  <input type="button" class="btn btn-primary" value="Back >>" >
                                                </a>  </div>
                                   ...
                                   <li class="pendingTimeline">
                                    ...
                                    <p></p>
                                     ...
                                     <li class="rejectTimeline">
                                       ...
                                       <p  class="mt-2"><span class= "spanclr"> Rejected Date :   </span>@if(@$formData['officer_status_date']!=null) {{ \Carbon\Carbon::parse(@$formData['officer_status_date'])->format('d-m-Y h:i a') }}@endif</p>
                                    ...
                                    <li class="pendingTimeline">
                                     ...
                                     <p></p>
                                      <p class="inputText badge bg-warning" style="font-size: 12px">Pending </p>
                                       ...
                                       @if(@$formData->officer_status == 1)
                                       @if( @$formData->Dc_status == 1)
                      
                                       <li class="ApproveTimeline">
                                         <a href="#!">Directorate clerk</a>
                                         <a href="#!" class="float-end"><i class="fa fa-eye"></i>  {{ @$formData['Dc_view_date'] }}</a>
                                         <p></p>
                                         <p class="inputText badge bg-success" style="font-size: 12px">Approved </p>
                                         <p  class="mt-2"><span class= "spanclr"> Name :   </span>{{ @$formData->DcUser->name }}</p>
                                        
                                         <p  class="mt-2"><span class= "spanclr"> Approved Date :   </span>@if(@$formData['Dc_status_date']!=null) {{ \Carbon\Carbon::parse(@$formData['Dc_status_date'])->format('d-m-Y h:i a') }}@endif</p>
                                         <p  class="mt-2"><span class= "spanclr"> Approved Reason :   </span>{{ @$formData->Dc_status_reason}}</p>
                                      </li>
                                      @elseif( @$formData->Dc_status == 2)
                                      ...
                                      <li class="rejectTimeline">
                                        ...
                                        <p  class="mt-2"><span class= "spanclr"> Rejected Date :   </span>@if(@$formData['Dc_status_date']!=null) {{ \Carbon\Carbon::parse(@$formData['Dc_status_date'])->format('d-m-Y h:i a') }}@endif</p>
                                        <p  class="mt-2"><span class= "spanclr"> Rejected Reason :   </span>{{ @$formData->Dc_status_reason}}</p>
                                     </li>
                                     @elseif( @$formData->Dc_status == null)
                                     ...
                                     <li class="pendingTimeline">
                                      ...
                                      <p></p>
                                       <p class="inputText badge bg-warning" style="font-size: 12px">Pending </p>
                                        ...
                                        @if(@$formData->Dc_status == 1)
                                        @if( @$formData->D_JsSeo_status == 1)
                       
                                        <li class="ApproveTimeline">
                                          <a href="#!">Directorate JS/SEO</a>
                                          <a href="#!" class="float-end"><i class="fa fa-eye"></i>  {{ @$formData['D_JsSeo_view_date'] }}</a>
                                          <p></p>
                                          <p class="inputText badge bg-success" style="font-size: 12px">Approved </p>
                                          <p  class="mt-2"><span class= "spanclr"> Name :   </span>{{ @$formData->D_JsSeoUser->name }}</p>
                                         
                                          <p  class="mt-2"><span class= "spanclr"> Approved Date :   </span>@if(@$formData['D_JsSeo_status_date']!=null) {{ \Carbon\Carbon::parse(@$formData['D_JsSeo_status_date'])->format('d-m-Y h:i a') }}@endif</p>
                                          <p  class="mt-2"><span class= "spanclr"> Approved Reason :   </span>{{ @$formData->D_JsSeo_status_reason}}</p>
                                       </li>
                                       @elseif( @$formData->D_JsSeo_status == 2)
                                       ...
                                       <li class="rejectTimeline">
                                         ...
                                         <p  class="mt-2"><span class= "spanclr"> Rejected Date :   </span>@if(@$formData['D_JsSeo_status_date']!=null) {{ \Carbon\Carbon::parse(@$formData['D_JsSeo_status_date'])->format('d-m-Y h:i a') }}@endif</p>
                                         <p  class="mt-2"><span class= "spanclr"> Rejected Reason :   </span>{{ @$formData->D_JsSeo_status_reason}}</p>
                                      </li>
                                      @elseif( @$formData->D_JsSeo_status == null)
                                      ...
                                      <li class="pendingTimeline">
                                       ...
                                       <p></p>
                                        <p class="inputText badge bg-warning" style="font-size: 12px">Pending </p>
                                         ...
                                         @if(@$formData->D_JsSeo_status == 1)
                                         @if( @$formData->D_ad_status == 1)
                        
                                         <li class="ApproveTimeline">
                                           <a href="#!">Directorate Ass Director</a>
                                           <a href="#!" class="float-end"><i class="fa fa-eye"></i>  {{ @$formData['D_ad_view_date'] }}</a>
                                           <p></p>
                                           <p class="inputText badge bg-success" style="font-size: 12px">Approved </p>
                                           <p  class="mt-2"><span class= "spanclr"> Name :   </span>{{ @$formData->D_adUser->name }}</p>
                                          
                                           <p  class="mt-2"><span class= "spanclr"> Approved Date :   </span>@if(@$formData['D_ad_status_date']!=null) {{ \Carbon\Carbon::parse(@$formData['D_ad_status_date'])->format('d-m-Y h:i a') }}@endif</p>
                                           <p  class="mt-2"><span class= "spanclr"> Approved Reason :   </span>{{ @$formData->D_ad_status_reason}}</p>
                                        </li>
                                        @elseif( @$formData->D_ad_status == 2)
                                        ...
                                        <li class="rejectTimeline">
                                          ...
                                          <p  class="mt-2"><span class= "spanclr"> Rejected Date :   </span>@if(@$formData['D_ad_status_date']!=null) {{ \Carbon\Carbon::parse(@$formData['D_ad_status_date'])->format('d-m-Y h:i a') }}@endif</p>
                                          <p  class="mt-2"><span class= "spanclr"> Rejected Reason :   </span>{{ @$formData->D_ad_status_reason}}</p>
                                       </li>
                                       @elseif( @$formData->D_ad_status == null)
                                       ...
                                       <li class="pendingTimeline">
                                        ...
                                        <p></p>
                                         <p class="inputText badge bg-warning" style="font-size: 12px">Pending </p>
                                          ...
                                          @if(@$formData->D_ad_status == 1)
                                          @if( @$formData->D_jd_status == 1)
                         
                                          <li class="ApproveTimeline">
                                            <a href="#!">Directorate Joint Director</a>
                                            <a href="#!" class="float-end"><i class="fa fa-eye"></i>  {{ @$formData['D_jd_view_date'] }}</a>
                                            <p></p>
                                            <p class="inputText badge bg-success" style="font-size: 12px">Approved </p>
                                            <p  class="mt-2"><span class= "spanclr"> Name :   </span>{{ @$formData->D_jdUser->name }}</p>
                                           
                                            <p  class="mt-2"><span class= "spanclr"> Approved Date :   </span>@if(@$formData['D_jd_status_date']!=null) {{ \Carbon\Carbon::parse(@$formData['D_jd_status_date'])->format('d-m-Y h:i a') }}@endif</p>
                                            <p  class="mt-2"><span class= "spanclr"> Approved Reason :   </span>{{ @$formData->D_jd_status_reason}}</p>
                                         </li>
                                         @elseif( @$formData->D_jd_status == 2)
                                         ...
                                         <li class="rejectTimeline">
                                           ...
                                           <p  class="mt-2"><span class= "spanclr"> Rejected Date :   </span>@if(@$formData['D_jd_status_date']!=null) {{ \Carbon\Carbon::parse(@$formData['D_jd_status_date'])->format('d-m-Y h:i a') }}@endif</p>
                                           <p  class="mt-2"><span class= "spanclr"> Rejected Reason :   </span>{{ @$formData->D_jd_status_reason}}</p>
                                        </li>
                                        @elseif( @$formData->D_jd_status == null)
                                        ...
                                        <li class="pendingTimeline">
                                         ...
                                         <p></p>
                                          <p class="inputText badge bg-warning" style="font-size: 12px">Pending </p>
                                           ...
                                           @if(@$formData->D_jd_status == 1)
                                           @if( @$formData->Sa_status == 1)
                          
                                           <li class="ApproveTimeline">
                                             <a href="#!">Secretariat Asst</a>
                                             <a href="#!" class="float-end"><i class="fa fa-eye"></i>  {{ @$formData['Sa_view_date'] }}</a>
                                             <p></p>
                                             <p class="inputText badge bg-success" style="font-size: 12px">Approved </p>
                                             <p  class="mt-2"><span class= "spanclr"> Name :   </span>{{ @$formData->SaUser->name }}</p>
                                            
                                             <p  class="mt-2"><span class= "spanclr"> Approved Date :   </span>@if(@$formData['Sa_status_date']!=null) {{ \Carbon\Carbon::parse(@$formData['Sa_status_date'])->format('d-m-Y h:i a') }}@endif</p>
                                             <p  class="mt-2"><span class= "spanclr"> Approved Reason :   </span>{{ @$formData->Sa_status_reason}}</p>
                                          </li>
                                          @elseif( @$formData->Sa_status == 2)
                                          ...
                                          <li class="rejectTimeline">
                                            ...
                                            <p  class="mt-2"><span class= "spanclr"> Rejected Date :   </span>@if(@$formData['Sa_status_date']!=null) {{ \Carbon\Carbon::parse(@$formData['Sa_status_date'])->format('d-m-Y h:i a') }}@endif</p>
                                            <p  class="mt-2"><span class= "spanclr"> Rejected Reason :   </span>{{ @$formData->Sa_status_reason}}</p>
                                         </li>
                                         @elseif( @$formData->Sa_status == null)
                                         ...
                                         <li class="pendingTimeline">
                                          ...
                                          <p></p>
                                           <p class="inputText badge bg-warning" style="font-size: 12px">Pending </p>
                                            ...
                                            @if(@$formData->Sa_status == 1)
                                            @if( @$formData->S_so_status == 1)
                           
                                            <li class="ApproveTimeline">
                                              <a href="#!">Secretariat Section Officer</a>
                                              <a href="#!" class="float-end"><i class="fa fa-eye"></i>  {{ @$formData['S_so_view_date'] }}</a>
                                              <p></p>
                                              <p class="inputText badge bg-success" style="font-size: 12px">Approved </p>
                                              <p  class="mt-2"><span class= "spanclr"> Name :   </span>{{ @$formData->S_soUser->name }}</p>
                                             
                                              <p  class="mt-2"><span class= "spanclr"> Approved Date :   </span>@if(@$formData['S_so_status_date']!=null) {{ \Carbon\Carbon::parse(@$formData['S_so_status_date'])->format('d-m-Y h:i a') }}@endif</p>
                                              <p  class="mt-2"><span class= "spanclr"> Approved Reason :   </span>{{ @$formData->S_so_status_reason}}</p>
                                           </li>
                                           @elseif( @$formData->S_so_status == 2)
                                           ...
                                           <li class="rejectTimeline">
                                             ...
                                             <p  class="mt-2"><span class= "spanclr"> Rejected Date :   </span>@if(@$formData['S_so_status_date']!=null) {{ \Carbon\Carbon::parse(@$formData['S_so_status_date'])->format('d-m-Y h:i a') }}@endif</p>
                                             <p  class="mt-2"><span class= "spanclr"> Rejected Reason :   </span>{{ @$formData->S_so_status_reason}}</p>
                                          </li>
                                          @elseif( @$formData->S_so_status == null)
                                          ...
                                          <li class="pendingTimeline">
                                           ...
                                           <p></p>
                                            <p class="inputText badge bg-warning" style="font-size: 12px">Pending </p>
                                             ...
                                             @if(@$formData->S_so_status == 1)
                                             @if( @$formData->S_us_status == 1)
                            
                                             <li class="ApproveTimeline">
                                               <a href="#!">Secretariat Under Secretary</a>
                                               <a href="#!" class="float-end"><i class="fa fa-eye"></i>  {{ @$formData['S_us_view_date'] }}</a>
                                               <p></p>
                                               <p class="inputText badge bg-success" style="font-size: 12px">Approved </p>
                                               <p  class="mt-2"><span class= "spanclr"> Name :   </span>{{ @$formData->S_usUser->name }}</p>
                                              
                                               <p  class="mt-2"><span class= "spanclr"> Approved Date :   </span>@if(@$formData['S_us_status_date']!=null) {{ \Carbon\Carbon::parse(@$formData['S_us_status_date'])->format('d-m-Y h:i a') }}@endif</p>
                                               <p  class="mt-2"><span class= "spanclr"> Approved Reason :   </span>{{ @$formData->S_us_status_reason}}</p>
                                            </li>
                                            @elseif( @$formData->S_us_status == 2)
                                            ...
                                            <li class="rejectTimeline">
                                              ...
                                              <p  class="mt-2"><span class= "spanclr"> Rejected Date :   </span>@if(@$formData['S_us_status_date']!=null) {{ \Carbon\Carbon::parse(@$formData['S_us_status_date'])->format('d-m-Y h:i a') }}@endif</p>
                                              <p  class="mt-2"><span class= "spanclr"> Rejected Reason :   </span>{{ @$formData->S_us_status_reason}}</p>
                                           </li>
                                           @elseif( @$formData->S_us_status == null)
                                           ...
                                           <li class="pendingTimeline">
                                            ...
                                            <p></p>
                                             <p class="inputText badge bg-warning" style="font-size: 12px">Pending </p>
                                              ...
                                              @if(@$formData->S_us_status == 1)
                                              @if( @$formData->S_as_status == 1)
                             
                                              <li class="ApproveTimeline">
                                                <a href="#!">Secretariat Additional Secretary</a>
                                                <a href="#!" class="float-end"><i class="fa fa-eye"></i>  {{ @$formData['S_as_view_date'] }}</a>
                                                <p></p>
                                                <p class="inputText badge bg-success" style="font-size: 12px">Approved </p>
                                                <p  class="mt-2"><span class= "spanclr"> Name :   </span>{{ @$formData->S_asUser->name }}</p>
                                               
                                                <p  class="mt-2"><span class= "spanclr"> Approved Date :   </span>@if(@$formData['S_as_status_date']!=null) {{ \Carbon\Carbon::parse(@$formData['S_as_status_date'])->format('d-m-Y h:i a') }}@endif</p>
                                                <p  class="mt-2"><span class= "spanclr"> Approved Reason :   </span>{{ @$formData->S_as_status_reason}}</p>
                                             </li>
                                             @elseif( @$formData->S_as_status == 2)
                                             ...
                                             <li class="rejectTimeline">
                                               ...
                                               <p  class="mt-2"><span class= "spanclr"> Rejected Date :   </span>@if(@$formData['S_as_status_date']!=null) {{ \Carbon\Carbon::parse(@$formData['S_as_status_date'])->format('d-m-Y h:i a') }}@endif</p>
                                               <p  class="mt-2"><span class= "spanclr"> Rejected Reason :   </span>{{ @$formData->S_as_status_reason}}</p>
                                            </li>
                                            @elseif( @$formData->S_as_status == null)
                                            ...
                                            <li class="pendingTimeline">
                                             ...
                                             <p></p>
                                              <p class="inputText badge bg-warning" style="font-size: 12px">Pending </p>
                                               ...
                                               @if(@$formData->S_as_status == 1)
                                               @if( @$formData->S_acs_status == 1)
                              
                                               <li class="ApproveTimeline">
                                                 <a href="#!">Secretariat Additional Chief secretary</a>
                                                 <a href="#!" class="float-end"><i class="fa fa-eye"></i>  {{ @$formData['S_acs_view_date'] }}</a>
                                                 <p></p>
                                                 <p class="inputText badge bg-success" style="font-size: 12px">Approved </p>
                                                 <p  class="mt-2"><span class= "spanclr"> Name :   </span>{{ @$formData->S_acsUser->name }}</p>
                                                
                                                 <p  class="mt-2"><span class= "spanclr"> Approved Date :   </span>@if(@$formData['S_acs_status_date']!=null) {{ \Carbon\Carbon::parse(@$formData['S_acs_status_date'])->format('d-m-Y h:i a') }}@endif</p>
                                                 <p  class="mt-2"><span class= "spanclr"> Approved Reason :   </span>{{ @$formData->S_acs_status_reason}}</p>
                                              </li>
                                              @elseif( @$formData->S_acs_status == 2)
                                              ...
                                              <li class="rejectTimeline">
                                                ...
                                                <p  class="mt-2"><span class= "spanclr"> Rejected Date :   </span>@if(@$formData['S_acs_status_date']!=null) {{ \Carbon\Carbon::parse(@$formData['S_acs_status_date'])->format('d-m-Y h:i a') }}@endif</p>
                                                <p  class="mt-2"><span class= "spanclr"> Rejected Reason :   </span>{{ @$formData->S_acs_status_reason}}</p>
                                             </li>
                                             @elseif( @$formData->S_acs_status == null)
                                             ...
                                             <li class="pendingTimeline">
                                              ...
                                              <p></p>
                                               <p class="inputText badge bg-warning" style="font-size: 12px">Pending </p>
                                                ...
                                                @if(@$formData->S_acs_status == 1)
                                                @if( @$formData->Mo_status == 1)
                               
                                                <li class="ApproveTimeline">
                                                  <a href="#!">Minister Office</a>
                                                  <a href="#!" class="float-end"><i class="fa fa-eye"></i>  {{ @$formData['Mo_view_date'] }}</a>
                                                  <p></p>
                                                  <p class="inputText badge bg-success" style="font-size: 12px">Approved </p>
                                                  <p  class="mt-2"><span class= "spanclr"> Name :   </span>{{ @$formData->MoUser->name }}</p>
                                                 
                                                  <p  class="mt-2"><span class= "spanclr"> Approved Date :   </span>@if(@$formData['Mo_status_date']!=null) {{ \Carbon\Carbon::parse(@$formData['Mo_status_date'])->format('d-m-Y h:i a') }}@endif</p>
                                                  <p  class="mt-2"><span class= "spanclr"> Approved Reason :   </span>{{ @$formData->Mo_status_reason}}</p>
                                               </li>
                                               @elseif( @$formData->Mo_status == 2)
                                               ...
                                               <li class="rejectTimeline">
                                                 ...
                                                 <p  class="mt-2"><span class= "spanclr"> Rejected Date :   </span>@if(@$formData['Mo_status_date']!=null) {{ \Carbon\Carbon::parse(@$formData['Mo_status_date'])->format('d-m-Y h:i a') }}@endif</p>
                                                 <p  class="mt-2"><span class= "spanclr"> Rejected Reason :   </span>{{ @$formData->Mo_status_reason}}</p>
                                              </li>
                                              @elseif( @$formData->Mo_status == null)
    ...
    <script type="text/javascript">
        ...
        $(document).on("click", ".approveItem", function() {
            var id =$(this).attr('data-id');
                ...
                $.ajax({
                            url: "{{ route('singleEarner-Dc.approve') }}",
                            type: "POST",
                            data: {
                                "id": reqId,
                                "reason" :reason,
            ...
            function reject() {
                    ...
                    $.ajax({
                        ...
                        url: "{{ route('singleEarner-Dc.reject') }}",
                        type: "POST",
                            data: {
                                "id": reqId,
                                "reason" :reason,
